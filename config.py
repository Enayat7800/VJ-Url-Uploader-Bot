...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6611439999:AAEDykIF7TG7aaRXLSwDXIqhvBm1Z6XEN74")
    TECH_VJ_BOT_USERNAME = os.environ.get("Meranewbot_bot", "") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "28150346"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "426f0d0a1da02dea8fb71cb0bd3ab7e1")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "1251962299")) 
    TECH_VJ_SESSION_NAME = "VJ-URL-UPLOADER-BOT"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://inayatalibarkaat:enayatalibarkaat@cluster0.1gt1a4m.mongodb.net/?retryWrites=true&w=majority")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1001819528169")) # your log channel id and make bot admin in log channel with full right 
